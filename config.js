...
- ${PREFIX}myrank — Show your rank profile`,
  ...
  noActive: mode => `📉 No active messages found for ${mode} ranking yet.`,
  notRanked: '📉 You haven’t sent any messages yet. Start chatting to get ranked!'
};
